package com.bachdv.lib.common.aspect;

import com.bachdv.lib.common.aspect.annotation.AutoLog;
...
public class AutoLogAspect {
    ...
    @Pointcut("@annotation(com.bachdv.lib.common.aspect.annotation.AutoLog)")
